...
extern void initTimerInterrupt(void);
...
//        int regByte = read_codec_register(CODEC_MAP_OVFL_CLK_STATUS);
//        if (regByte) {
...
void chiptune_callback()        // called at 8 KHz
{
    u8 i;
    s16 acc;
    u8 newbit;
